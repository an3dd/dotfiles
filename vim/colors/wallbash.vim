...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['131313', '828282', '949494', '949494',
    ...
    let g:terminal_ansi_colors = ['FFFFFF', 'B8B8B8', 'D6D6D6', 'D6D6D6',
                                \ 'B8B8B8', 'FCFCFC', 'FCFCFC', '434343',
                                \ 'FFFFFF', 'D6D6D6', 'FCFCFC', 'FCFCFC',
                                \ 'D6D6D6', 'FCFCFC', 'FCFCFC', '131313']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#434343 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#434343 gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#434343 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#131313 guibg=#FCFCFC gui=bold cterm=bold
  hi TabLineSeparator guifg=#828282 guibg=#434343 gui=NONE cterm=NONE
  ...
  hi CursorColumn guifg=NONE guibg=#434343 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#434343 gui=italic cterm=italic
  ...
  " hi NeoTreeCursorLine guibg=#B8B8B8 guifg=#131313 gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#434343 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#333333 gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#FCFCFC guifg=#131313 gui=bold cterm=bold
  hi BufferTabpageFill guibg=#131313 guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#FFFFFF guibg=#434343 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#434343 gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#3D3D3D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#131313 guibg=#FFFFFF gui=NONE cterm=NONE
  ...
  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#131313 guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  ...
  hi CmpItemAbbr guifg=#131313 guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#434343 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#1A1A1A guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#434343 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Cursor guibg=#131313 guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi TermCursor guibg=#131313 guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#131313 gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi FoldColumn guifg=#333333 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#131313 guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#131313 gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#1A1A1A guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#131313 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#131313 guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#333333 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#1A1A1A guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#434343 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#131313 guibg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferInactive guifg=#434343 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi TelescopeSelection guibg=#FCFCFC guifg=#131313 gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#FCFCFC gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#B8B8B8 guifg=#131313 gui=bold cterm=bold
hi TelescopeMatching guifg=#949494 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#FCFCFC guifg=#131313 gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FCFCFC guifg=#131313 gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FCFCFC guifg=#131313 gui=bold
hi WildMenu guibg=#FCFCFC guifg=#131313 gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#FCFCFC guifg=#131313 gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#FCFCFC guifg=#131313 gui=bold cterm=bold |
    \ else |
